...
module.exports = {
    name: "handleregist",
    description: "Menampilkan Panel Register Kota Metro Roleplay:Rp",
    /**
     *
     * @param {Client} client
    ...
    run: async (client, interaction, args) => {
        ...
        .setAuthor({ name:"Metro Roleplay Roleplay", iconURL:client.config.ICON_URL })
        .setColor("GOLD")
        .setTitle("User Control Panel Metro Roleplay Roleplay")
        .setDescription("Halo Player!!, Selamat datang di Metro Roleplay Roleplay, disini adalah tempat untuk mengatur User Control Panel anda Seperti Mendaftar, dll")
        ...
        .setFooter({ text:"Bot Metro Roleplay Official" })
        .setTimestamp()
